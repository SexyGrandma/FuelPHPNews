...
return array(
    ...
    'mdb' => array(
        ...
        'wrapper' => "<nav class=\"my-4\" aria-label=\"...\"><ul class=\"pagination pagination-circle justify-content-center\">\n\t{pagination}\n</ul></nav>\n",
        ...
        'active-link' => "\t\t<a class=\"page-link\" href=\"{uri}\">{page}</a>\n",
